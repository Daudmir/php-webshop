...
<nav class="bg-gray-800">
    ...
    <h1 class="text-3xl font-bold text-gray-900 text-center mt-12 mb-20">All Products</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        while($row = $result->fetch_assoc()){
            ...
            <div class='bg-white shadow-md rounded-lg p-6'>
                ...
                <a href='products.php?add={$row["id"]}' class='bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded'>Add to cart</a>
            </div>
            ";
        }
        ?>
